...
public class RegularFragment extends ListFragment {
    ...
    private ArrayList<AppDetail> data;  //经常使用的App本身的数据，如图标、名称和提议
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if(getArguments().containsKey("regulary")){ //获取经常使用的App信息并用ListView显示出来
            ArrayList<AppInfo> appInfos = (ArrayList<AppInfo>) getArguments().getSerializable("regulary");
...
//            Log.d("xyz",app.toString());
            ...
            try {
                ...
                appDetail.setDescribe("经常使用，建议更新！");
